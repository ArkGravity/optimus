...
// Handler wires the workload Service into Gin. Route mounting lives in the
...
// List handles GET /k8s/clusters/:id/workloads/:kind. The kind path param
...
// Get handles GET /k8s/clusters/:id/workloads/:kind/:ns/:name.
