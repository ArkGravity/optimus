...
func TestExactRoutePermissionSnapshotContainsNoAlert(t *testing.T) {
	...
	want := map[string]string{
		...
		"GET /api/v1/observability/query-sources": "observability:metric:read", "GET /api/v1/observability/datasources/:id/labels": "observability:metric:read", "GET /api/v1/observability/datasources/:id/label-values": "observability:metric:read", "POST /api/v1/observability/query": "observability:metric:read", "POST /api/v1/observability/query-range": "observability:metric:read",
